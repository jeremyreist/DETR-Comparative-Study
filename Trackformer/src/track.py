...
def main(seed, dataset_name, obj_detect_checkpoint_file, tracker_cfg,
    ...
    def calculateMIoU(results: dict):
        ...
        for k1 in results.keys():
            for k2 in results[k1].keys():
                ious.append(results[k1][k2]['score'])
    ...
    if obj_detector_model is None:
        ...
        _log.info(f'\n{str_summary}')
        print('MIoU for trackformer MOT20: ', calculateMIoU(results))
        return summary
